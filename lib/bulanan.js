 ...
 * @param {Object} _dir 
 */
const addBulananUser = (userId, expired, _dir) => {
 ...
 * @returns {Number}
 */
const getBulananPosition = (userId, _dir) => {
    let position = null
 ...
 * @returns {Number}
 */
const getBulananExpired = (userId, _dir) => {
    let position = null
    Object.keys(_dir).forEach((i) => {
        if (_dir[i].id === userId) {
            position = i
 ...
 * @returns {Boolean}
 */
const checkBulananUser = (userId, _dir) => {
    let status = false
    Object.keys(_dir).forEach((i) => {
        if (_dir[i].id === userId) {
            status = true
 ...
 * @param {Object} _dir 
 */
const expiredBulananCheck = (haruka, _dir) => {
    setInterval(() => {
        let position = null
        Object.keys(_dir).forEach((i) => {
