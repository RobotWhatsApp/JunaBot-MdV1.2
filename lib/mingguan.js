 ...
 * @param {Object} _dir 
 */
const addMingguanUser = (userId, expired, _dir) => {
 ...
 * @returns {Number}
 */
const getMingguanPosition = (userId, _dir) => {
    let position = null
 ...
 * @returns {Number}
 */
const getMingguanExpired = (userId, _dir) => {
    let position = null
    Object.keys(_dir).forEach((i) => {
        if (_dir[i].id === userId) {
            position = i
 ...
 * @returns {Boolean}
 */
const checkMingguanUser = (userId, _dir) => {
    let status = false
    Object.keys(_dir).forEach((i) => {
        if (_dir[i].id === userId) {
            status = true
 ...
 * @param {Object} _dir 
 */
const expiredMingguanCheck = (haruka, _dir) => {
    setInterval(() => {
        let position = null
        Object.keys(_dir).forEach((i) => {
